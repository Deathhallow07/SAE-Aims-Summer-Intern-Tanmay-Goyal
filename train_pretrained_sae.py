...
ACTS_PATH = "acts/pretrained_code_acts.pt"
SAVE_PATH = "models/pretrained_pythia160m_code_layer6_sae.pt"
...
for epoch in range(SAE_EPOCHS):
    ...
    for batch in tqdm(train_loader, desc=f"pre sae epoch {epoch + 1}/{SAE_EPOCHS}"):
        x = batch[0].to(DEVICE)
