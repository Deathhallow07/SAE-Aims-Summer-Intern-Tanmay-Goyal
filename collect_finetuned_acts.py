...
FT_MODEL_PATH = "models/pythia160m_code_finetuned.pt"

SAVE_ACTS = "acts/finetuned_code_acts.pt"
SAVE_TOKENS = "acts/finetuned_code_tokens.json"
...
ckpt = torch.load(FT_MODEL_PATH, map_location=DEVICE)
